    ...
    <div className="p-5 space-y-6">
      ...
      <div className="space-y-4">
         ...
         <div className="grid grid-cols-4 gap-4">
            <ToolIcon icon={<Truck size={20} />} label="Rentals" color="bg-orange-100 text-orange-600" />
            <ToolIcon icon={<Calendar size={20} />} label="Calendar" color="bg-blue-100 text-blue-600" />
            <ToolIcon icon={<Bell size={20} />} label="Alerts" color="bg-red-100 text-red-600" />
            <ToolIcon icon={<Layers size={20} />} label="Reports" color="bg-green-100 text-green-600" />
         </div>
      </div>
    </div>
  );
