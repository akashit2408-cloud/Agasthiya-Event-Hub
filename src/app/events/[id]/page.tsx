    ...
    <div className="flex flex-col min-h-screen bg-white pb-10">
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <button onClick={handleCancelEvent} className="w-full py-4 bg-danger/10 text-danger rounded-2xl font-black text-sm uppercase tracking-widest mt-4 active:scale-95 transition-transform">
            Cancel Event
          </button>
        </div>
      </div>
